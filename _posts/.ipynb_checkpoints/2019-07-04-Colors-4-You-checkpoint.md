...
<figure class="image">
  <img src="{{http://www.onepiecepodcast.com/wp-content/uploads/2018/01/color-810x466.png}}" alt="{{ One piece manga full colored page }}">
  <figcaption>{{ include.description }}</figcaption>
</figure>    
    
##Data collection and data processing (h2)
----
...
## Convolution Neural Network model (h2)
----
...
## Deep Convolutional Generative Adversarial Network (DcGAN) (h2)
----
