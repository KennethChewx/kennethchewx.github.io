...
<div style="width:image width px; font-size:80%; text-align:center;">
    <img src="https://cdn-media-1.freecodecamp.org/images/K3OU3lMzzks0UI-MGAap-fmYCuVhpjHKvTzQ" alt="Image taken from unsplash from emilwallner dataset" width=210px height=710px style="padding-bottom:0.5em;" />*Image taken from unsplash from emilwallner dataset*
</div>
...
<div style="width:image width px; font-size:80%; text-align:center;">
    <img src="../../../img/gen.png" alt="Generator training diagram" width=210px height=610px style="padding-bottom:0.5em;"/>*Generator training diagram*
</div> 

<div style="width:image width px; font-size:80%; text-align:center;">
    <img src="../../../img/dis.png" alt="Generator training diagram" width=210px height=610px style="padding-bottom:0.5em;" />*Discriminator training diagram*
</div> 
