...
With the incorporation of both convolutional layers and GANs, we get [DcGANs](https://arxiv.org/pdf/1511.06434.pdf), which utilises convolutional stride in downsampling the input and transposed convolution for upsampling. This makes DcGANs much simpler model that reduces the complexity of the generator and discriminator without causing bottleneck in image quality.
