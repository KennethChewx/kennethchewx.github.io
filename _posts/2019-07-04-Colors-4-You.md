...
<div style="width:image width px; font-size:80%; text-align:center;">
    <img src="https://cdn-media-1.freecodecamp.org/images/K3OU3lMzzks0UI-MGAap-fmYCuVhpjHKvTzQ" alt="Image taken from unsplash from emilwallner dataset" style="padding-bottom:0.5em;" />*Image taken from unsplash from emilwallner dataset*
</div>
